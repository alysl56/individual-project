...
write.csv(as.data.frame(res), file.path(out_dir,"U937_DESeq2_results.csv"))
write.csv(as.data.frame(normCounts), file.path(out_dir,"U937_normalized_counts.csv"))
saveRDS(dds, file.path(out_dir,"U937_dds.rds"))
