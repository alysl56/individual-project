...
write.csv(as.data.frame(res), file.path(out_dir,"A549_DESeq2_results.csv"))
write.csv(as.data.frame(normCounts), file.path(out_dir,"A549_normalized_counts.csv"))
saveRDS(dds, file.path(out_dir,"A549_dds.rds"))
