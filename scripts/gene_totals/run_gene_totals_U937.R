...
write.csv(out_sample, file.path(base,"DE_analysis","U937_gene_totals_per_sample.csv"), row.names=FALSE)
write.csv(summ, file.path(base,"DE_analysis","U937_gene_totals_by_condition.csv"), row.names=FALSE)
