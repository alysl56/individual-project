...
write.csv(summ, file.path(base,"DE_analysis","HepG2_DEG_summary.csv"), row.names=FALSE)
write.csv(annotate_tbl(top_up), file.path(base,"DE_analysis","HepG2_top10_up.csv"), row.names=FALSE)
write.csv(annotate_tbl(top_down), file.path(base,"DE_analysis","HepG2_top10_down.csv"), row.names=FALSE)
