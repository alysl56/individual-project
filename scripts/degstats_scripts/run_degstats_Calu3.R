...
write.csv(summ, file.path(base,"DE_analysis","Calu3_DEG_summary.csv"), row.names=FALSE)
write.csv(annotate_tbl(top_up), file.path(base,"DE_analysis","Calu3_top10_up.csv"), row.names=FALSE)
write.csv(annotate_tbl(top_down), file.path(base,"DE_analysis","Calu3_top10_down.csv"), row.names=FALSE)
